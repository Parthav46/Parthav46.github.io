    ...
    <>
      ...
      {process.env.NODE_ENV !== "production" && (
        <ThemeManager>
          ...
          <main style={{ marginTop: 60, padding: 24, maxWidth: 900, marginLeft: "auto", marginRight: "auto" }}>
            <div ref={sectionRefs.bio} id="bio" style={{ minHeight: "100vh", scrollMarginTop: 70 }}>
              <Bio />
            </div>
            <div ref={sectionRefs.skills} id="skills" style={{ minHeight: "100vh", scrollMarginTop: 70 }}>
              <Skills />
            </div>
            <div ref={sectionRefs.experience} id="experience" style={{ minHeight: "100vh", scrollMarginTop: 70 }}>
              <Experience />
            </div>
            <div ref={sectionRefs.projects} id="projects" style={{ minHeight: "100vh", scrollMarginTop: 70 }}>
              <Projects />
            </div>
          </main>
        </ThemeManager>
